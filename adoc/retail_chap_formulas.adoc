...
Its main purpose is to resolve saltboot hostnames such as TFTP, FTP, or Salt and the terminal names if configured.
Zone 2 is the reverse zone of Zone 1.
It is reponsible for resolving IP addresses back to hostnames.
...
*  On top of that, Zone 2 should have configured:
