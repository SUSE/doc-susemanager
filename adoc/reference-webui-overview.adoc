...
[NOTE]
====
If you forget your password or username, go to the sign in screen and click the menu:Header[About] link, then select the menu:About[Lookup Login/Password] page.
