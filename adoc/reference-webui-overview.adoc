...
* The menu:Overview[Tasks] section lists the most common tasks an administrator performs via the Web interface. Click any link to reach the page within {susemgr} that allows you to accomplish that task.
+
