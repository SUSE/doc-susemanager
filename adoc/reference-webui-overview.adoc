...
[NOTE]
====
New to the {susemgr} Webui? Browse the <<reference-webui-intro.adoc#_reference-webui-intro, Navigation>> topic to familiarize yourself with the layout and symbols used throughout this guide.
====
endif::[]
