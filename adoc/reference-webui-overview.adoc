...
[abstract]
--
This topic introduces you to basic use of the {susemgr} WebUI.
...
[NOTE]
====
New to the {susemgr} Webui? Scan through the <<reference-webui-intro.adoc#_reference-webui-intro, Navigation>> topic to familiarize yourself with the layout and symbols used throughout this guide.
====
endif::[]
...
Lookup or reset your username and password from the menu:About[Lookup Login/Password] page.
