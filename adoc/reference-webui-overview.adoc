...
* menu:Your Preferences["Overview" Start Page] -- Select the information sections that are displayed on the menu:Home[Overview] page of the menu:The Menu[Home].
Check the box to the left of the information section you would like to include.
