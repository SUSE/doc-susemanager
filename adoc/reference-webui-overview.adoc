...
ifdef::env-github[]
<<reference-webui-intro.adoc#_reference-webui-intro, Navigation>>
endif::[]
...
Before logging in, select menu:Header[About], to browse and search available documentation topics.
You may also lookup your login credentials if either your _username_ or _password_ is lost.

Lookup or reset your username and password from menu:About[Lookup Login/Password].
For more information, see: <<_ref.webui.overview.account>>

Login to the {susemgr} WebUI to view the menu:Home[Overview] page.
The Overview page contains summary panes which provide important information about your systems.
