...
By default all the notification types are enabled.
In case you have the need to disable any notification type you can configure it in the [path]``/etc/rhn/rhn.conf``:
