...
* The menu:Home[Notification Messages] page displays two tabs (menu:Notification Messages[Unread Messages] and menu:Notification Messages[All Messages]) with a list of all your collected messages.
