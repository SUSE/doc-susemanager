...
The menu:Home[Notification Messages] page allows you to manage your notification messages of the {susemgr} server.

image::home_notification_messages.png[scaledwidth=80%]

The menu:Home[Notification Messages] page displays two tabs:

* menu:Notification Messages[Unread Messages]
* menu:Notification Messages[All Messages]) 

Both of these tabs contain a list of all collected messages filtered by the tab name.

There are three buttons for working with notification messages:
