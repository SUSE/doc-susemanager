...
[NOTE]
====
New to the {susemgr} Webui? Read <<reference-webui-intro.adoc#_reference-webui-intro, Navigation>> to familiarize yourself with the layout and symbols used throughout this guide.
====
endif::[]
