...
.Overview/Recently Registered Systems
image::home_overview_system_groups_pane.png[scaledwidth=80%]

* The menu:Overview[Recently Registered Systems] pane lists the systems added to the {susemgr} in the past 30 days.
Click a system's name to see its menu:System[System Details] page.
Click the link below this pane to menu:Overview[View All Recently Registered Systems] on one page.
+
