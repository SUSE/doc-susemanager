...
From the {webui} proceed to menu:Overview[Tasks > Manage Activation Keys].
...
With the addition of Salt to {productname} 3 states should now be considered best practice over the more traditional way of combining activation keys.
