...
The [code]``mgr-create-bootstrap-repo`` command is used on the {susemgr} Server to create a new bootstrap repository.
...
[NOTE]
. Flushing a Bootstrap Repo to Remove Custom Channels
====
