...
After it has been created and configured, you can begin data collection from your VHMs manually through the {webui}, by navigating to menu:Systems[Virtual Host Managers], selecting the appropriate VHM, and clicking btn:[Refresh Data].
...
In order to manage your VHMs with XMLRPC, you will need to configure them to use the XMLRPC APIs.
