...
+
* image:spacewalk-icon-virtual-host.png[Virtual Host,scaledwidth=1em]
 -- Virtual Host.
* image:spacewalk-icon-virtual-guest.png[Virtual Guest,scaledwidth=1em]
 -- Virtual Guest.
* image:fa-236-non-virtual-system.png[Non-Virtual System,scaledwidth=1em]
 -- Non-Virtual System.
* image:spacewalk-icon-unprov-system.png[Unprovisioned System,scaledwidth=1em]
...
+
* image:fa-check-circle.png[Check Circle,scaledwidth=1em]
