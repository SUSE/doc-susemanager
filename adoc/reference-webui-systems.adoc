...
image::systems_physical_systems.png[width=80%]
...
image::systems_virtual_systems.png[scaledwidth=468]
...
image::systems_bare_metal.png[scaledwidth=468]
...
image::systems_outofdate.png[scaledwidth=468]
...
image::systems_requiringreboot.png[scaledwidth=468]
...
image::systems_noncompliant.png[scaledwidth=468]
...
image::systems_without_system_type.png[scaledwidth=468]
...
image::systems_ungrouped.png[scaledwidth=468]
...
image::systems_inactive.png[scaledwidth=468]
...
image::systems_recently_registered.png[scaledwidth=468]
...
image::systems_proxy.png[scaledwidth=468]
...
image::systems_duplicate_systems.png[scaledwidth=468]
...
image::systems_currency_report.png[scaledwidth=468]
...
image::systems_system_types.png[scaledwidth=468]
...
image::system_details_traditional_overview.png[scaledwidth=468]


.System Details Overview (Salt Minion) [[_fig.system_details.details.overview.salt]]

image::system_details_salt_overview.png[width=80%]
...
NOTE: If updates are available for any entitled system, the message menu:Software Updates Available[]
...
NOTE: The system ID can be used to eliminate duplicate profiles from {susemgr}
.
...
IMPORTANT: Locking a system in the Web interface _will not_ prevent any actions that originate from the client system.
...
NOTE: Systems with Salt or Management system type can be rebooted from this screen. 
...
image::system_details_traditional_edit.png[scaledwidth=468]
...
image::system_details_reactivation.png[scaledwidth=468]
...
image::system_details_traditional_migrate.png[scaledwidth=400]
...
image::system_details_traditional_notes.png[scaledwidth=400]
...
image::system_details_traditional_custom_info.png[scaledwidth=400]
...
image::system_details_traditional_software_patches.png[scaledwidth=400]
...
image::system_details_traditional_software_packages.png[scaledwidth=400]
...
NOTE: This feature only works if Zypper is used as the package manager.
...
image::system_details_traditional_software_system_channels.png[scaledwidth=400]
...
image::system_details_traditional_software_sp_migration.png[scaledwidth=400]
...
image::system_details_traditional_configuration_overview.png[scaledwidth=400]
...
+
image::system_details_traditional_configuration_view_mod_central_paths.png[scaledwidth=400]
...
+
image::system_details_traditional_configuration_view_mod_local_paths.png[scaledwidth=400]
...
Local Sandbox::
+
image::system_details_traditional_configuration_view_mod_sandbox_paths.png[scaledwidth=400]
...
Upload File::
+
image::system_details_traditional_configuration_add_files_upload.png[scaledwidth=400]
...
Import Files::
+
image::system_details_traditional_configuration_add_files_import.png[scaledwidth=400]
...
Create File::
+
image::system_details_traditional_configuration_add_files_create.png[scaledwidth=400]
...
image::system_details_traditional_configuration_deploy_file.png[scaledwidth=400]
...
image::system_details_traditional_configuration_diff_file.png[scaledwidth=400]
...
image::system_details_traditional_configuration_config_channel_list.png[scaledwidth=400]
...
image::system_details_traditional_provisioning_schedule_wizard.png[scaledwidth=400]
...
image::system_details_traditional_provisioning_power_management.png[scaledwidth=400]
...
image::system_details_traditional_provisioning_snapshot_index.png[scaledwidth=400]
...
image::system_details_traditional_list_groups.png[scaledwidth=400]
...
image::system_details_traditional_add_group.png[scaledwidth=400]
...
image::system_details_traditional_list_audit.png[scaledwidth=400]



image::system_details_traditional_schedule_audit.png[scaledwidth=400]
...
image::system_details_salt_states_packages.png[scaledwidth=400]
...
image::system_details_salt_states_custom.png[scaledwidth=400]
...
image::system_details_salt_states_highstate.png[scaledwidth=400]
...
image::system_details_traditional_events_pending.png[scaledwidth=400]
...
image::system_details_traditional_events_history.png[scaledwidth=400]
...
image::systems_systemgroups.png[scaledwidth=400]
...
image::systems_edit_group.png[scaledwidth=400]
...
image::systems_ssm_overview.png[scaledwidth=400]
...
image::systems_ssm_list_systems.png[scaledwidth=400]
...
image::systems_ssm_patches.png[scaledwidth=400]
...
image::systems_ssm_packages_overview.png[scaledwidth=400]
...
image::systems_ssm_install.png[scaledwidth=400]
...
image::systems_ssm_remove.png[scaledwidth=400]
...
image::systems_ssm_upgrade.png[scaledwidth=400]
...
image::systems_ssm_verify.png[scaledwidth=400]
...
image::systems_ssm_groups.png[scaledwidth=400]
...
image::systems_ssm_base_channels.png[scaledwidth=400]
+
...
image::systems_ssm_child_subscriptions.png[scaledwidth=400]
+
...
image::systems_ssm_config_deploy_files.png[scaledwidth=400]
...
image::systems_ssm_config_compare_files.png[scaledwidth=400]
...
image::systems_ssm_config_subscribe_to_channels.png[scaledwidth=400]
...
image::systems_ssm_config_unsubscribe_from_channels.png[scaledwidth=400]
...
image::systems_ssm_config_enable_config.png[scaledwidth=80%]
...
image::systems_ssm_autoinstallation.png[scaledwidth=400]
...
image::systems_ssm_tag_systems.png[scaledwidth=400]
...
image::systems_ssm_rollback.png[scaledwidth=400]
...
image::systems_ssm_remote_command.png[scaledwidth=400]
...
image::systems_ssm_power_management_config.png[scaledwidth=400]
...
image::systems_ssm_power_management_operations.png[scaledwidth=400]
...
image::systems_ssm_audit.png[scaledwidth=400]
...
image::systems_ssm_misc_hardware_refresh.png[scaledwidth=400]
...
image::systems_ssm_misc_software_refresh.png[scaledwidth=400]
...
image::systems_ssm_misc_migrate_systems.png[scaledwidth=400]
...
image::systems_ssm_misc_lock_unlock.png[scaledwidth=400]
...
image::systems_ssm_misc_delete_confirm.png[scaledwidth=400]
...
image::bootstrapping.png[scaledwidth=444]
...
image::systems_proxy_heirarchy.png[scaledwidth=400]
...
image::visualization_system_grouping_all.png[scaledwidth=400]
...
image::visualization_system_grouping.png[scaledwidth=400]
...
image::systems_advanced_search.png[scaledwidth=400]
...
image::systems_activation_keys.png[scaledwidth=400]
...
image::systems_stored_profiles.png[scaledwidth=400]
...
image::systems_custom_system_info.png[scaledwidth=400]
...
image::systems_virtual_host_managers_vmware.png[scaledwidth=344]
...
image::systems_virtual_host_managers_file.png[scaledwidth=96%]
