...
+
* image:svg/spacewalk-icon-virtual-host.svg[Virtual Host,scaledwidth=1em]
 -- Virtual Host. 
* image:svg/spacewalk-icon-virtual-guest.svg[Virtual Guest,scaledwidth=1em]
 -- Virtual Guest. 
* image:svg/fa-236-non-virtual-system.svg[Non-Virtual System,scaledwidth=1em]
 -- Non-Virtual System. 
* image:svg/spacewalk-icon-unprov-system.svg[Unprovisioned System,scaledwidth=1em]
...
+
* image:svg/fa-check-circle.svg[Check Circle,scaledwidth=1em]
 -- System is up-to-date. 
* image:fa-exclamation-circle.png[Exclamation Circle,scaledwidth=1em]
 -- Critical patch (errata) available, update _strongly_
      recommended. 
* image:fa-warning.png[Warning,scaledwidth=1em]
 -- Updates available and recommended. 
* image:fa-question-circle.png[Question,scaledwidth=1em]
 -- System not checking in properly (for 24 hours or more). 
* image:fa-lock.png[Lock,scaledwidth=1em]
 -- System is locked; actions prohibited. 
* image:fa-rocket.png[Rocket,scaledwidth=1em]
 -- System is being deployed using {ay}
 or Kickstart. 
* image:fa-clock-o.png[Clock,scaledwidth=1em]
 -- Updates have been scheduled. 
* image:fa-times-circle.png[Times,scaledwidth=1em]
...
** image:fa-check-circle.png[Check Circle,scaledwidth=1em] -- All systems in the group are up-to-date. 
** image:fa-exclamation-circle.png[Exclamation Circle,scaledwidth=1em] -- Critical patches available, update _strongly_ recommended. 
** image:fa-warning.png[Warning,scaledwidth=1em] -- Updates available and recommended. 
