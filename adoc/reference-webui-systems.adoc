...
This is done through the menu:System Set Manager[]
 ...
 pages.
Refer to <<ref.webui.systems.ssm>> or <<_s3_sm_system_details>>, respectively.
...
.Enable Configuration [[fig-ssm-config-enable]]
...
To change the settings of a key, click the key's description in the list to display its menu:Details[]
 page (see <<fig-s1-sm-systems-akey-details>>). Via additional tabs you can select child channels, packages, configuration channels, group membership and view activated systems.
...
.Activation Key Details With Subtabs [[fig-s1-sm-systems-akey-details]]
...
[[ref.webui.systems.virt_host_managers]]
...
[[ref.webui.systems.virt_host_managers.vmware]]
=== VMware-Based
...
[[ref.webui.systems.virt_host_managers.file]]
=== File-Based
