...
image::image-building.png[scaledwidth=400]
...
image::systems_create_activation_key.png[scaledwidth=400]
...
image::images_image_stores_create.png[scaledwidth=400]
...
image::images_image_profiles.png[scaledwidth=400]
