...
If you want to build {sle} 15 images (when available), the Kiwi image build system must run on a {sle} 15 build host.
The required version of Kiwi will only be available on a {sle} 15 build host.
