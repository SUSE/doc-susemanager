...
Alternatively, you can import [path]``retail.yml`` using this command to only import only the new systems and groups defined in the file, and leave any existing configuration settings untouched:
