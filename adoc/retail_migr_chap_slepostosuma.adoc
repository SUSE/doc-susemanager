...
To finalize the branch server migration, you must install the branch server machines as Salt-based minions and bootstrap them as proxies.
For more information about proxy installation, see xref:retail_chap_install.adoc#retail.sect.install.branch[Installing and Registrering].
