...
image::enable_live_patching_channels.png[scaledwidth=400]
...
image::enable_live_patching_kgraft_install.png[scaledwidth=400]
. Apply the highstate to enable live patching: 
+


image::enable_live_patching_apply_highstate.png[scaledwidth=400]
...
image::enable_live_patching_successful.png[scaledwidth=400]
