[[_advanced.topics.monitoring.with.icinga]]
...
.Open Firewall Port`IMPORTANT: Allow port 5432` through your firewall or you will not be able to access the WebGUI.
