...
image::audit_cve_audit.png[scaledwidth=400]
...
image::audit_subscription_matching.png[scaledwidth=400]
...
image::smatching-overview.png[scaledwidth=96%]
...
image::audit_subscription_matching_gatherer_matcher_default.png[scaledwidth=96%]
...
image::audit_subscription_matching_unmatched_products.png[scaledwidth=96%]
...
image::audit_subscription_matching_pins.png[scaledwidth=96%]
...
image::sm-pins.png[scaledwidth=96%]
...
image::add-pin.png[scaledwidth=333]
...
image::audit_subscription_matching_messages.png[scaledwidth=96%]
