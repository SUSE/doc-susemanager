...
* The image:patch-status-affected-patch-applicable.png[[orange],scaledwidth=1em] state is displayed when {susemgr} has at least one patch in an assigned channel.
