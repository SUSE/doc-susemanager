...
.Procedure: Installing the {smr} pattern on the Central Server
...
Manually create the [systemitem]``Terminals`` and [systemitem]``Servers`` system groups during installation.
