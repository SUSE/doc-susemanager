...
For instructions see the xref:command-line-tools.adoc#syncing.suse.mgr.repositories.scc[Syncing {susemgr} Repositories from SCC (mgr-sync)].
...
For instructions see the xref:reference-webui-channels.adoc#ref.webui.channels[Software Channels Reference]
