...
Your build host should be a Salt minion, running {sls}{nbsp}12, SP{nbsp}3.
See [quickstart3_chap_suma_keys_and_first_clients.adoc] for instructions to install Salt minions.
