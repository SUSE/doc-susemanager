...
. Create mandatory system group _TERMINALS_

Branch server installation steps:

. Install a branch server and register it to {susemgr}
...
=== Procedure Create mandatory system group _TERMINALS_

Registration routine expects mandatory system group to exists. This system group has a name

``TERMINALS``

and needs to be manually created during {smr} installation. For instructions to create system group see xref:reference-webui-systems.adoc#ref.webui.systems.systemgroups[System groups reference]
