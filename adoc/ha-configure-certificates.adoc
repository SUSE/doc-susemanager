...
image::33-1.png[Start the YaST CA Module]
...
image::33-2.png[New CA Password]

. Verify your CA data is correct and then create it.
+

image::33-3.png[Verify CA Data]
...
image::33-9.png[New Server Certificate Step 1]

. Ensure *Use CA Password as Certificate Password* is selected then select *Next* to continue.
+

image::33-10.png[Create New Server Certificate Step 2]
...
image::33-12.png[Add Alt Names]

. Your result should be similar to the following image:
+

image::33-13.png[Final Alt Names]
