...
* image:fa-shield.png[Security Alert,scaledwidth=1em]{mdash}
 represents a security alert. 
* image:fa-bug.png[Bug Fix Alert,scaledwidth=1em]{mdash}
 represents a bug fix alert. 
* image:spacewalk-icon-enhancement.png[Enhancement Alert,scaledwidth=1em]{mdash}
