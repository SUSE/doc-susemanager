...
. Completing the unfinished action.
An unfinished action can occur if the server missed the results of the action.
. Cleanup of remaining artifacts after action completion.
For example, it removes script files of corresponding script actions.
