...
////
lbrindley: This references up2date, so I think we can assume it's deprecated.
2018-12-10, ke: /etc/sysconfig/rhn/up2date still exists and I assume some tools will still use it.
                Or do we now have a different config file for all these features?
////
