...
* menu:Build Host[] : Select a Build Host. For creating a Build Host, see <<at.images.docker.Buildhost>>.
...
* menu:Build Type[] : Dockerfile and Kiwi are available. Use Dockerfile to build containers and Kiwi to build system, virtual, and other types of images.
