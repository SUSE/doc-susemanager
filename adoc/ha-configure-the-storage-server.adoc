...
image::step2-iscsi-lio-service-on-boot.png[Service on Boot Screen, scaledwidth=80%]
...
image::step3-lio-target-auth.png[No Authentication Screen, scaledwidth=80%]

. Proceed to the *Target* screen by pressing (kbd:[alt+shift+T]).
+

image::step4-lio-targets.png[LIO Targets Screen, scaledwidth=80%]
...
image::step5-assign-luns.png[Assign LUNS, scaledwidth=80%]

. Select next to continue kbd:[alt+shift+N].
+

image::step6-modify-initiators-acls.png[Modify Initiators Screen, scaledwidth=80%]
...
image::step7-add-initiators-names.png[Add Initiator Names, scaledwidth=80%]

. Your initiator should look similar to the following:
+

image::step8-added-initiators.png[Added Initiators, scaledwidth=80%]
...
image::step9-initiator-discovery.png[Initiator Discovery, scaledwidth=80%]
...
image::step10-connect-clients.png[Connect Clients, scaledwidth=80%]
