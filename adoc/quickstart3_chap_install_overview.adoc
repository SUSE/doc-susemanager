...
| Disk Space | Minimum 100 GB for root partition

               _For the purposes of this guide the default JeOS root partition size of 24 GB will be sufficient_
...
| {sle} 12 SP1, SP2, SP3                               | {x86}_64, IBM {power}({ppc64le}), {zseries}  | Supported           | Supported
