...
* https://www.suse.com/documentation/sles-12/book_sle_admin/data/sec_basicnet_yast.html#sec_basicnet_yast_change_host[SLES 12 Administration Guide - FQDN]
...
| 443  | Outbound         | {susemgr} uses this port to reach {scc} (unless running in a disconnected mode with RMT or SMT as described in:
ifndef::env-github[]
<<_disconnect_setup>>
endif::[]
ifdef::env-github[]
