...
This procedure will work for traditionally  managed systems (system type [systemitem]``management``).  Using Salt (system type [systemitem]``salt``), for the time being, it will not be available.
