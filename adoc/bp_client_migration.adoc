...
image::sles_old_details_page.png[scaledwidth=400]
...
image::sles_old_details_spmigration.png[scaledwidth=400]
...
image::sles_migration_target.png[scaledwidth=400]
...
image::sles_migration_channels.png[scaledwidth=400]
...
image::sles_migration_schedule.png[scaledwidth=400]
...
image::sles_migrated.png[scaledwidth=400]
