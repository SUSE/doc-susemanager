...
{smr} works well for deployments containing up to around 5000 terminals.
Larger installation are possible with appropriate planning.
Please involve the SUSE Consulting team for further assistance if you intend to install more than 5000 terminals.
