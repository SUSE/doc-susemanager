...
* image:spacewalk-icon-software-channels.png[Spacewalk Icon Software Channels,scaledwidth=1em]
 -- Centrally-managed configuration file provided by a global
       configuration channel. 
* image:fa-desktop.png[FA Desktop,scaledwidth=1em]
 -- [Management] Locally-managed configuration file, maybe overriding a
       centrally-managed file. 
* image:spacewalk-icon-sandbox.png[Spacewalk Icon Sandbox,scaledwidth=1em]
...
NOTE: A sandbox icon (image:spacewalk-icon-sandbox.png[Spacewalk Icon Sandbox,scaledwidth=0.9em]
