...
// ianew: upgrade/migration-overview.adoc
// iawho: keichwa 2019-01-31
...
====
{productname} Server 3.1 must _not_ be migrated to SLES 12 SP3 or later before upgrading PostgreSQL to version 9.6.
====
...
// ianew: upgrade/server-upgrade.adoc
// iawho: keichwa 2019-01-31
...
// ianew: upgrade/migrate-3_1-3_2.adoc
// iawho: keichwa 2019-01-31
