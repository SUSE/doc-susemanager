...
You need to restart these services manually to avoid potential failures. You may use [command]``zypper ps`` to check for any applications which may be using old code.
...
image::yast_migration_target31.png[scaledwidth=400]
