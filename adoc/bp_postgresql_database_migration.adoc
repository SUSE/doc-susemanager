...
You can check if the system is ready to use PostgreSQL 9.6 with this command:
...
This is why the latest version of smdba is required.
...
Before you begin, ensure you have a database backup.
Perform a fast migration with this command:
