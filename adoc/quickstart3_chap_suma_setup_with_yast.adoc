...
image::quickstart-mgr-setup4.png[scaledwidth=400]
...
image::quickstart-mgr-setup5.png[scaledwidth=400]
...
image::quickstart-mgr-setup6.png[scaledwidth=400]
...
image::quickstart-mgr-setup-admin1.png[scaledwidth=400]
