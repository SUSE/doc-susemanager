...
----
suma21:/var/lib/pgsql#
du -sch data
1,8G    data
1,8G    total
suma21:/var/spacewalk/tmp#
ls -lh susemanager.dmp.gz
...
For more information about the PostgreSQL upgrade, see <<_sp.migration.postgresql>>. 
