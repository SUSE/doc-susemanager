...
After the installation is completed, a bootstrap script located on the {productname} server will be executed in order to register the freshly installed system with {productname}.
You need to adjust the IP address of the {productname} server, the name of the bootstrap script and the root password according to your needs in the following lines:
