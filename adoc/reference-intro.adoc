...
{susemgr} enables you to efficiently manage a set of Linux systems and keep them up-to-date.
...
{susemgr} is compatible with {rh} Satellite Server and offers seamless management of both {sle} and {rhel} client systems.
