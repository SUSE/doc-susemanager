...
* image:fa-shield.png[Security Alert,scaledwidth=1em] -- Security Updates available, _strongly_ recommended 
* image:fa-bug.png[Bug Fix Alert,scaledwidth=1em] -- Bug Fix Updates available, recommended 
* image:spacewalk-icon-enhancement.png[Enhancement Alert,scaledwidth=1em] -- Enhancement Updates available, optional 
