...
Change these options to fit your needs, then click the btn:[Save Preferences] button for changes to take effect.
...
ifndef::env-github,backend-html5[]
<<s5-sm-system-details-groups-join>> or <<ref.webui.systems.systemgroups.details>>.
endif::[]
ifdef::env-github,backend-html5[]
<<reference-webui-systems.adoc#s5-sm-system-details-groups-join, Groups > Join>> or <<reference-webui-systems.adoc#ref.webui.systems.systemgroups.details, System Groups>>.
endif::[]
