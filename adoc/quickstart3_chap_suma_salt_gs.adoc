...
[NOTE]
====
You can also apply the highstate from the previous formula tab from the {susemgr} {webui} by selecting menu:System Details[States] and clicking btn:[Apply Highstate].
====
