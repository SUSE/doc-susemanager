...
A good analogy for this directory would be the {susemgr} database translated into Salt directives.
+
...
{susemgr} does not touch or do anything with this directory.
