...
----
+
Display the OS name of all minions with the [path]``webserver`` label:
+
...
[TIP]
====
You can use the [command]``ip`` command to find the subnet mask in the format of [path]``192.168.1.1/24``:
