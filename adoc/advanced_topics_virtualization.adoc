...
* Autoinstallation is still not supported.
...
Alternatively, check one or more menu:Guests[] listed in the table and click the corresponding button above the table.
menu:Confirm[] the action on the displayed popup dialog.
...
Click the menu:Edit[] button on the {vmguest} row.
Change the values to the desired ones in the next page and click the menu:Update[] button to apply.
...
To delete a {vmguest}, navigate to the {vmhost}'s menu:Virtualization[] page.
Click the menu:Delete[] button on the {vmguest} row.
Alternatively, check one or more menu:Guests[] listed in the table and click the menu:Delete[] button above the table.
menu:Confirm[] the action on the displayed popup dialog.
