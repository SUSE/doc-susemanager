...
image::rhnsd-taigon.png[scaledwidth=400]
...
image::sshpush-taigon.png[scaledwidth=400]
...
image::salt-ssh-contact-taigon.png[scaledwidth=400]
...
image::osad.png[scaledwidth=400]
