...
=== Viewing rhnsd Daemon or Timer Status

As the {rootuser} you may view the status of the [systemitem]``rhnsd`` daemon with:

----
/etc/init.d/rhnsd status
----

And the status of the [systemitem]``rhnsd`` service with:
