...
| 22   | TCP      | SSH
| 67   | TCP/UDP  | DHCP
| 69   | TCP/UDP  | TFTP, used to support PXE services
| 80   | TCP      | HTTP, used in some bootstrap cases
| 123  | UDP      | NTP time service
| 443  | TCP      | HTTPS, used for {webui}, client, and proxy server traffic
| 5222 | TCP      | XMPP client, used for communications with the [systemitem]``osad`` daemon on client systems
