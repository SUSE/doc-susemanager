...
image::schedule_failed_actions.png[scaledwidth=400]
...
image::schedule_completed_actions.png[scaledwidth=400]
...
image::schedule_archived_actions.png[scaledwidth=400]
