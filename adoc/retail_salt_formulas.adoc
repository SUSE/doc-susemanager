...
[NOTE]
====
When you install a Salt Formula, It may have the same name as one of your existing Salt states and thus colling. This may result in the formula being used instead of your state.

Before you install Formulas, {suse} recommends to check your current states and rename them to avoid name clashes.
====
