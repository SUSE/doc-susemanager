...
* You can decrease the amount of time required for writing a formula by grabbing a pre-written one from the https://github.com/saltstack-formulas[Saltstack formula repository on Github].
