...
<a href="https://github.com/SUSE/doc-susemanager"><img alt="GitHub Actions status" src="https://github.com/SUSE/doc-susemanager/workflows/build%20test%20deploy/badge.svg"></a>
