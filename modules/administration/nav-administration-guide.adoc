...
// We need to keep this, regardless as it is a functionality of the web interface. There is a note in the introduction.
// Virtualization
...
// Monitoring
include::modules/administration/pages/prometheus.adoc[leveloffset=+1]
...
include::modules/administration/pages/virt-xenkvm.adoc[leveloffset=+2]

include::modules/administration/pages/virt-vmware.adoc[leveloffset=+2]

include::modules/administration/pages/virt-file.adoc[leveloffset=+2]
...
include::modules/administration/pages/tuning-changelogmetadata.adoc[leveloffset=+1]
