...
// Troubleshooting
** xref:tshoot-corruptrepo.adoc[Troubleshooting Corrupt Repositores]
...
** xref:tshoot-reports.adoc[Troubleshooting Reports]
...
// Troubleshooting
include::modules/administration/pages/tshoot-corruptrepo.adoc[leveloffset=+1]
include::modules/administration/pages/tshoot-localcert.adoc[leveloffset=+1]
include::modules/administration/pages/tshoot-osadjabberd.adoc[leveloffset=+1]
include::modules/administration/pages/tshoot-packages.adoc[leveloffset=+1]
include::modules/administration/pages/tshoot-registerclones.adoc[leveloffset=+1]
include::modules/administration/pages/tshoot-reports.adoc[leveloffset=+1]
include::modules/administration/pages/tshoot-rpctimeout.adoc[leveloffset=+1]
