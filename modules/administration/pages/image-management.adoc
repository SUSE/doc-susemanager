...
. From the [guimenu]``System Details`` page of the selected minion assign the containers modules.
...
// FIXME CHECKIT
The Kiwi image building feature is available for Salt minions running {sls}{nbsp}12 or 15.
// FIXME CHECKIT
...
OS image build hosts are Salt minions running {sls}{nbsp}12 (SP3 or later) or 15.
