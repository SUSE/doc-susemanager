...
The Kiwi image building feature is available for Salt clients running {sles}{nbsp}12.
...
OS Image build hosts are Salt clients running {sles}{nbsp}12 (SP3 or later) or 15.
