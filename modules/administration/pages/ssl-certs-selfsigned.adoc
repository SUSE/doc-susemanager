...
This method does not use a third party certificate authority to guarantee that the details of the certificate are correct.

It provides basic checking between the {productname} Server and the clients, but will not protect you against man-in-the-middle attacks.
