...
Updating salt-minion, zypper and any other related management package on clients is not a strict requirement, but it is a best practice in general.
...
{suse} makes sure that salt-minion can always be updated safely.
