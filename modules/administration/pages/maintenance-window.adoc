[[maintenance-window]]
= {productname} Server Maintenance Window
...
Second point is to add a section about Inter-Server Sync Slaves, which should be updated as soon as the update to the main (Master) Server is completed.



== {productname} Proxy

Third point is to add a section about Proxies, which should be updated after all Servers updates are complete.
