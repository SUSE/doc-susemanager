...
The above settings should be regarded as guidelines.
The setting have been tested to be safe but care should be exercised when changing them, and consulting support is highly recommended.
