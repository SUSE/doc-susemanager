...
[NOTE]
====
Depending on your environment and settings, you might receive an ``invalid certificate`` error when you connect to the ESXi server from a browser using HTTPS.
