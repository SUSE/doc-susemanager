...
Virtual Host Managers (VHMs) can be used to manage one or more virtual hosts, and each virtual host can contain one or more virtual guests.

In {productname}, VHMs can be based on VMWare, or created from a JSON file.
