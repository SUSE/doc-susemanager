...
. To add the ISS master, click btn:[Add new master].
...
* To synchronize all organizations to this slave, check the [guimenu]``Sync All Orgs to Slave?`` checkbox.
. To add the ISS slave, click btn:[Create].
