...
You can use {productname} to manage {k8s} clusters.

{productname} communicates with your {k8s} clusters using a virtual host manager.
This allows {productname} to obtain and report information about your clusters, including the ability to do CVE audits, and report if containers are outdated.
...
. In the {productname} {webui}, navigate to menu:Images[Image List], and upload the existing image that you want to import.
