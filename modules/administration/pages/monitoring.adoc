...
When you have the exporters installed and configured, you can enable and configure monitoring.
...
. On the monitoring server, open the Prometheus static configuration file at [path]``/etc/prometheus/prometheus.yml``.
