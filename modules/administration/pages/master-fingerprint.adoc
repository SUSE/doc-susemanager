...
On your minion, open the [path]``/etc/salt/minion`` configuration file. .
...
For information on configuring security from a minion, see https://docs.saltstack.com/en/latest/ref/configuration/minion.html.
