// 2019-07-24, ke: Is it supported on Salt minions only?
// This seems to indicate it: "Installing and configuring exporters is done using a Salt formula."
// If yes, we'd better replace "mananged clients" with the term "Salt minions".
...
// I do not see why we should mention where this was started; we do not do this elsewhere
...
Prometheus is an open-source software project, mostly written in Go.
...
For more information about dashbords, see https://grafana.com/dashboards
