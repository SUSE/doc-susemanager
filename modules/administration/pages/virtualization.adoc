...
When the registration process is finished and all packages have been installed, enable [daemon]``osad`` (open source architecture daemon).
...
In case an installation has failed, you can btn:[Reschedule] it from this page when you have corrected the problem.
