...
include::modules/administration/pages/vhm-azure.adoc[leveloffset=+2]

include::modules/administration/pages/vhm-aws.adoc[leveloffset=+2]

include::modules/administration/pages/vhm-gce.adoc[leveloffset=+2]

include::modules/administration/pages/vhm-kubernetes.adoc[leveloffset=+2]

// include::modules/administration/pages/vhm-caasp.adoc[leveloffset=+2]
