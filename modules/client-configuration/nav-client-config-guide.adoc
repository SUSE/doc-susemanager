...
*** xref:manual-registration/registration-webui.adoc[Registering with the Web UI]
*** xref:manual-registration/registration-bootstrap.adoc[Registering with Bootstrap]
// Non-SUSE Clients
...
include::modules/client-configuration/pages/manual-registration/registration-webui.adoc[leveloffset=+2]

include::modules/client-configuration/pages/manual-registration/registration-bootstrap.adoc[leveloffset=+2]
