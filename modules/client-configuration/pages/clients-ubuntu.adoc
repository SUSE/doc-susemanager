...
[IMPORTANT]
====
You need all the new channels fully synchronized, including Universe (Universe contains important dependencies for salt), before bootstraping any Ubuntu client.
====
endif::[]
