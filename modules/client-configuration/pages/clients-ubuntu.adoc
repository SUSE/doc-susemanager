...
+
----
sudo spacewalk-common-channels ubuntu-1804-amd64
----
. Synchronize the new custom channels.

[IMPORTANT]
====
You need all the new channels fully synchronized, including ``Universe``, before you can bootstrap an {ubuntu} client.
The Universe channel contains important dependencies for Salt.
====
