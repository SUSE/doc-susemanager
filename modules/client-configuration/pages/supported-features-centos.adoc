...
| Client | icon:question[role="gray"] (plain CentOS) / icon:check[role="green"] (with {es}) | icon:question[role="gray"] (plain CentOS) / icon:check[role="green"] (with {es}) | icon:question[role="gray"] (plain CentOS) / icon:check[role="green"] (with {es})
| Operating system packages  |  icon:times[role="danger"] (plain CentOS) / icon:check[role="green"] (with {es}) | icon:times[role="danger"] (plain CentOS)/icon:check[role="green"] (with {es}) | icon:times[role="danger"] (plain CentOS)/icon:check[role="green"] (with {es})
...
| Apply patches | icon:check[role="green"] (third-party service required for errata) | icon:check[role="green"] (third-party service required for errata) | icon:check[role="green"] (third-party service required for errata)
...
| System set manager (SSM) | icon:check[role="green"] | icon:check[role="green"] | icon:check[role="green"]
...
``Salt``: ZeroMQ, Salt-SSH | ``Traditional``: OSAD, RHNSD, SSH-push. ``Salt``: ZeroMQ, Salt-SSH | ``Traditional``: OSAD, RHNSD, SSH-push. ``Salt``: ZeroMQ, Salt-SSH
...
| Snapshots and profiles |  ``Traditional``. ``Salt``: Profiles supported, Sync not supported | ``Traditional``. ``Salt``: Profiles supported, Sync not supported | ``Traditional``. ``Salt``: Profiles supported, Sync not supported
