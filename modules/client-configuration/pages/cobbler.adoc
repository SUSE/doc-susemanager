...
Bare metal systems management can be enabled or disabled in the {productanme} {webui} by navigating to menu:Admin[SUSE Manager Configuration > Bare-metal systems].
