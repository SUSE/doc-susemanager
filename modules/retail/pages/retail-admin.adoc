...
Now, all the information about your point-of-service terminals is prepared.  Power on your point-of-service terminals and the branch server will bootstrap the terminals according to the provided data.
