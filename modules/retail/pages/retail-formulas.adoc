...
. In the [guimenu]``Records`` section, subsection [guimenu]``CNAME``, use these parameters to set up a CName record for Zone 1:
* In the [guimenu]``Key`` field, TBD
* In the [guimenu]``Value`` field, TBD
