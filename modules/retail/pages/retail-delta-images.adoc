...
The format of the parameters must be `<NAME>-<VERSION>` and they must correspond to
...
The resulting delta file is saved in [filename]``/srv/www/os-images`` and the corresponding {sls} file in [filename]``/srv/susemanager/pillar_data/images/``.
