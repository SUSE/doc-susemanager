...
Pools and respective updates.

// ondrej said:
////
sle-product-sles15-sp1-updates-x86_64
sle-product-suse-manager-retail-branch-server-4.0-updates-x86_64
sle-module-server-applications15-sp1-updates-x86_64-smrbs-4.0
sle-module-basesystem15-sp1-updates-x86_64-smrbs-4.0`

sle-manager-tools15-updates-x86_64-sp1
sle-module-desktop-applications15-sp1-updates-x86_64
