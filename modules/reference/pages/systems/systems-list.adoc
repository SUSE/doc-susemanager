...
For more information, see xref:reference:admin/bare-metal-systems.adoc[Bare-metal Systems].
...
Refer to xref:client-configuration:contact-methods.adoc[Contact Methods]
