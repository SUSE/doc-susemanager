...
In case of salt systems, there is a taskomatic job that checks on the minions by performing a test.ping on them.
...
* For salt systems, taskomatic might be down.
