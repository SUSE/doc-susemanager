...
* [guimenu]``Group Name`` -- The name of the group as configured during its creation. The name should be explicit enough to distinguish from other groups. Clicking the name of a group takes you to the [guimenu]``Details`` tab of its [guimenu]``System Group Details`` page. Refer to xref:reference:systesms/system-groups.adoc[] for more information.
* [guimenu]``Systems`` -- Total number of systems in the group. Clicking the number takes you to the [guimenu]``Systems`` tab of the [guimenu]``System Group Details`` page for the group. Refer to xref:reference:systesms/system-groups.adoc[] for more information.
* [guimenu]``Use in SSM`` -- Clicking the [guimenu]``Use in SSM`` link in this column loads all and only the systems in the selected group and launches the [guimenu]``System Set Manager`` immediately. Refer to xref:reference:systems/ssm-overview.adoc[] for more information.
...
Refer to xref:reference:systems/ssm-overview.adoc[] for more information.
...
Refer to xref:reference:systems/ssm-overview.adoc[] or xref:reference:systems/system-details.adoc[], respectively.
...
(Refer to xref:reference:patches/patch-details.adoc[] for more information.)
