...
For more information, refer to xref:reference:systems/system-details/sd-properties.adoc[SD Properties].
+
...
Refer to xref:reference:systems/system-groups.adoc[System Groups] for more information about System Groups.
====
+

It is also possible to lock multiple systems via the System Set Manager.
Refer to xref:reference:systems/ssm-overview.adoc#s4-sm-ssm-misc-lock[SSM Misc - Lock/Unlock] for instructions.
...
For more information, see xref:reference:systems/sd-software-channels.adoc[SD Software Channels].
