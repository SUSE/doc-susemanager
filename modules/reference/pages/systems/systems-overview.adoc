...
For more information, see xref:reference:systems/ssm-overview.adoc[System Set Manager Overview].
+
...
For more information, see xref:reference:systems/system-details.adoc[System Details].
+
