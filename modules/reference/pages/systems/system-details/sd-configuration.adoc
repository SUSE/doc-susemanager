...
Refer to xref:reference:configuration/config-menu.adoc[] for instructions on enabling and disabling scheduled actions for a system.
====
...
To watch progress, see xref:reference:systems/system-details/sd-events.adoc[].
