...
Within the configuration pages, you can manage systems via configuration files, and configure channels offering configuration files, and configuration files themselves.
