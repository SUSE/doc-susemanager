...
Refer to xref:reference:home/user-account-your-account.adoc[My Account] for more information.
...
Refer to xref:reference:home/home-your-preferences.adoc[My Preferences] for more information.
