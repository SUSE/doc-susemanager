...
[[spacewalk-repo-sync]]
== Synchronize yum Repositories into SUSE Manager Channels (spacewalk-repo-sync)

With [command]``spacewalk-repo-sync`` you synchronize yum repositories into {productname} channels.
