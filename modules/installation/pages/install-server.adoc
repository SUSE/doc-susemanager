...
[NOTE]
====
If you want to install {susemgr} on a virtual machine, ensure your virtual machine has enough disk space and RAM by checking the requirements at xref:[install-hardware-requirements]
====
