...
[NOTE]
====
The default {productname} server installation does not enable a graphical desktop environment.  If you want to run setup tools such {yast} with a graphical interface, select the [guimenu]``Desktop Applications Module``.
====
+
