...
{susemgr} 4.0 is a {suse} product of the {sle} 15 product family.
...
For information on registering with {scc}, or obtaining the Unified Installer, see xref:general-requirements.adoc[Requirements].
