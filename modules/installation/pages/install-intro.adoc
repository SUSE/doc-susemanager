...
This guide steps you through installing {susemgr} Server and Proxy.

Before you begin, check that your environment meets the requirements outlined in this book.

Once you have {susemgr} Server installed, read about installing and managing clients in the _Client Administration Guide_.
