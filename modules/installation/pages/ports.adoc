...
When you wish to push actions to clients this port is required by the [systemitem]``mgr-osad`` daemon running on your client systems.
...
For push actions and connections issued by [systemitem]``mgr-osad`` running on the client systems.
