...
. Bootstrap the client with the bootstrap script.  For more information, see xref:client-configuration/pages/registration-bootstrap.adoc[].
. In case of a Salt minion, accept the key on the menu:Main Menu[Salt > Keys] page by clicking the check mark.
