...
If you already have installation media for {slsa}{nbsp}15{nbsp}SP1, you can re-use it. 
Otherwise, download the installer from https://www.suse.com/products/suse-manager/download/[SUSE Manager Media Download]. 
This page will also allow you to retrieve an evaluation code for {productname} if you don't have a valid registration code yet.
