...
[[install.media]]
== Obtaining {slsa} Unified Installer
...
If not already done, download the {slsa} Unified Installer
(version {nbsp}15{nbsp}SP1 or higher) from
https://www.suse.com/products/server/download/[SUSE Linux Enterprise
Server - Media Download].  With the Unified Installer you can installf
many SLE-based base products such as {slsa}, {sled}, {slsa} for SAP
Applications, or {susemgr}.
