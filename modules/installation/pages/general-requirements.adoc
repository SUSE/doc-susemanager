...
{susemgr} Server and Proxy can be installed with the {slsa} Unified Installer.

ifeval::[{suma-content} == true]
You only require a valid registration code for {productname}. You do not require a separate code for {slsa} {sles-version} {sp-version}.
endif::[]
