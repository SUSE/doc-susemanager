...
If not already done, download the {sle} Unified Installer from https://download.suse.com/index.jsp, with the search parameters included it is one for example: https://download.suse.com/index.jsp?product_id=&search=Search&families=22609&version=68287 (version{nbsp}15{nbsp}SP1 or higher).
