...
This section covers the installation of {productname}{productnumber} as an extension to {sls}{nbsp}{sles-version}{sp-version}.
...
. Install {sls}{nbsp}{sles-version}{sp-version} from the installation media, and select {productname} as an extension.
