...
====
In the Public Clouds, the setup procedure will automatically create an administrator account. See <<pubclouds-credentials>>.
====
...
The user name automatically created for the administrator in the Public Clouds is `admin`.
