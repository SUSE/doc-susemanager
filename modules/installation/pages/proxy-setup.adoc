...
// This looks strange: The (important!) hint for the country code to require upper case only is part of the "City" field and the top "Country Code" only appears as tip.
