...
+
For more information about configuring the hostname and DNS, see link: https://documentation.suse.com/sles/15-SP1/html/SLES-all/cha-network.html#sec-network-yast-change-host.
