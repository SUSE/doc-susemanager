...
*** xref:public-cloud-requirements.adoc[Public Cloud Requirements]
** Installation
...
*** xref:public-cloud-registration.adoc[Registration in the Public Clouds]
** Setting Up
...
include::modules/installation/pages/public-cloud-requirements.adoc[leveloffset=+2]
...
// Registration in Public Clouds
include::modules/installation/pages/public-cloud-registration.adoc[leveloffset=+2]
