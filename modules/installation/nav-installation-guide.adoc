...
*** xref:install-server-unified.adoc[Installing SUSE Manager Server]
*** xref:install-proxy-unified.adoc[SUSE Manager 4.0 Proxy]
endif::[]
...
include::./resources/attributes-install.adoc[]
