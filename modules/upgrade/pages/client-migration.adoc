...
For more on this, see https://www.suse.com/documentation/sles-15/book_quickstarts/data/art_modules.html.
...
. In the {productname} Server {webui}, navigate to menu:Main Menu[Systems > Autoinstallation] and click [guimenu]``Upload Kickstart/Autoyast File``.
...
.Procedure: Migrating
. In the {productname} Server {webui}, navigate to menu:Main Menu[Systems] and select the client to be upgraded.
...
After the migration is complete, reboot the client.
