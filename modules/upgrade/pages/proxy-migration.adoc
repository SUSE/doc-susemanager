...
You will require {sle}{nbsp}15 SP1 installation media.
...
. On the {productname} Server {webui}, navigate to menu:Main Menu[Systems > Autoinstallation > Profiles] and upload your autoinstallation profile.
