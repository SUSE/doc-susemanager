...
If you want to upgrade {productname} 3.2 to {productname} 4 you must check whether {productname} 3.2 is already based PostgreSQL version 10.  If yes, you can skip this section.  If it is based on a older version such as 9.6 you must migrate PostgreSQL to version 10 first.





When you installed {productname} Server 3.1 or earlier on {sls}{nbsp}12{nbsp}SP2 or earlier, it was based on a PostgreSQL{nbsp}9.4 database.
PostgreSQL{nbsp}9.4 can be upgraded to PostgreSQL{nbsp}9.6.
...
{productname}{nbsp}3.1 on {sls}{nbsp}12{nbsp}SP3 and {productname}{nbsp}3.2 use PostgreSQL{nbsp}9.6 by default.
If you use one of those you can skip this section.
...
----
+
PostgreSQL{nbsp}9.6 requires smdba version 1.5.8 or later.
