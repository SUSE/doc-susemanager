...
The mitigations are available in {sles} 15 SP3 and later.
...
Manual::
Which just allows the user to decide
// More info on this? I can't see any way to select mitigations in the UI. LKB 2018-08-01
