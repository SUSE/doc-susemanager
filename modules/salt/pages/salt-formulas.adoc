...
----
/usr/share/salt-formulas/metadata/locale/
----
...
----
/usr/share/salt-formulas/metadata/locale/form.yml
----
...
// Antora Link
ifndef::backend-pdf[]
* xref::retail:retail-formulas.adoc[Retail Formulas]
endif::[]
...
[path]``/usr/share/salt-formulas/metadata/dhcpd/pillar.example``.
