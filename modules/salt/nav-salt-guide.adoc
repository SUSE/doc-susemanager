...
*** xref:salt-formulas-standard.adoc[Standard Formulas]
...
include::modules/salt/pages/salt-formulas-standard.adoc[leveloffset=+2]

include::modules/salt/pages/salt-formulas-custom.adoc[leveloffset=+2]
